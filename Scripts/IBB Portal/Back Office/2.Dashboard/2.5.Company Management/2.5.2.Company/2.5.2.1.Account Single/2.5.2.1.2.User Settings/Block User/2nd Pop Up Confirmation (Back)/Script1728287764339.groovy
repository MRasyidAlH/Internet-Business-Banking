...
WebUI.click(findTestObject('Object Repository/IBB Portal/Dashboard/Company Management/Company/User Settings/Block/btn_No'), FailureHandling.STOP_ON_FAILURE)