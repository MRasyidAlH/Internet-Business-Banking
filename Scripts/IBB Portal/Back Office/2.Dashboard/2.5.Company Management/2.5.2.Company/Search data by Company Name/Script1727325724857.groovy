...
GlobalVariable.DataTemporary = 'German Shepherd'
if(WebUI.verifyElementPresent(findTestObject('Object Repository/IBB Portal/Dashboard/Company Management/Company/lbl_Company Management') , GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
	...
	if(WebUI.verifyElementText(findTestObject('Object Repository/IBB Portal/Dashboard/Company Management/Company/span_CompanyName'), GlobalVariable.DataTemporary, FailureHandling.OPTIONAL)) {
